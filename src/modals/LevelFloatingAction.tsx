...
// type LevelType = "home" | "county" | "constituency" | "ward" | "ai" | "live" | "audioRoom";
...
export function FloatingLevelButton() {
  ...
  const selectLevel = (type: LevelType) => {
    ...
    if (type === "ai") return router.push("/");
    if (type === "live") return router.push("/live");
    if (type === "audioRoom") return router.push("/audio");
