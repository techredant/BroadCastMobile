...
// Fix: Use Animated.Value from 'react-native' not 'react-native-reanimated'
  ...
  return (
    <Modal visible={visible} animationType="slide" transparent={false}>
      <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
          ...
          >
            <Text style={{ fontWeight: "bold", fontSize: 16, color: theme.text }}>Comments</Text>
  ...
  >
    ...
    />
      ...
      {/* Comment Text */}
      <Text style={{ color: theme.text, marginTop: 2, lineHeight: 18 }}>
        {item.text}
      </Text>
      ...
      >
        ...
        >
          <Feather name="corner-up-left" size={16} color={theme.subtext} />
        ...
        >
          <Feather
            name="heart"
            size={16}
            color={item.likes?.includes(user?.id) ? "#E0245E" : theme.subtext}
          />
          <Text style={{ fontSize: 12, color: theme.subtext }}>
